      ...
      <ScrollView contentContainerStyle={{ paddingTop: topPad + 12, paddingBottom: 100, paddingHorizontal: 16 }}>
        ...
        {config && (
          <GlassCard style={{ marginBottom: 16 }}>
            <View style={{ padding: 14, flexDirection: "row", alignItems: "center", gap: 12 }}>
              ...
              <View style={{ flex: 1 }}>
                <Text style={{ color: isDark ? "#F0F8FF" : "#1a1a2e", fontFamily: "Inter_700Bold", fontSize: 13 }}>
                  {config.featureLabel}
                </Text>
                <Text style={{ color: isDark ? "rgba(255,255,255,0.55)" : "rgba(10,22,40,0.55)", fontFamily: "Inter_400Regular", fontSize: 12, marginTop: 2 }}>
        ...
        {!isAutopay && (
          <GlassCard style={{ marginBottom: 12 }}>
            <View style={{ padding: 4, flexDirection: "row", borderRadius: 18 }}>
              ...
              >
                <Text style={{ color: billingCycle === "monthly" ? "#FFF" : (isDark ? "rgba(255,255,255,0.55)" : "rgba(10,22,40,0.5)"), fontFamily: "Inter_700Bold", fontSize: 13 }}>📅 Monthly</Text>
              ...
              >
                <Text style={{ color: billingCycle === "yearly" ? "#FFF" : (isDark ? "rgba(255,255,255,0.55)" : "rgba(10,22,40,0.5)"), fontFamily: "Inter_700Bold", fontSize: 13 }}>🎁 Yearly</Text>
                {billingCycle === "yearly" ? (
                  <Text style={{ color: "rgba(255,255,255,0.85)", fontFamily: "Inter_700Bold", fontSize: 10, marginTop: 2 }}>2 months FREE!</Text>
                ) : (
                  <Text style={{ color: isDark ? "rgba(255,255,255,0.45)" : "rgba(10,22,40,0.4)", fontFamily: "Inter_400Regular", fontSize: 10, marginTop: 2 }}>Save ~17%</Text>
                )}
              </TouchableOpacity>
            </View>
          </GlassCard>
        ...
        <GlassCard style={{ marginBottom: 16 }}>
          <View style={{ padding: 4, flexDirection: "row", borderRadius: 18 }}>
            ...
            <TouchableOpacity
              ...
              style={{ flex: 1, paddingVertical: 11, borderRadius: 16, alignItems: "center", backgroundColor: !isAutopay ? (isDark ? "rgba(255,255,255,0.1)" : "rgba(0,119,182,0.12)") : "transparent" }}
            >
              ...
              {!isAutopay && <Text style={{ color: isDark ? "rgba(255,255,255,0.5)" : "rgba(10,22,40,0.4)", fontFamily: "Inter_400Regular", fontSize: 10, marginTop: 2 }}>{billingCycle === "yearly" ? "1 year" : "1 month"} only</Text>}
            </TouchableOpacity>
          </View>
        </GlassCard>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                  <View>
                    ...
                    <View style={{ flexDirection: "row", alignItems: "flex-end", gap: 4 }}>
                      {billingCycle === "yearly" ? (
                        <>
                          <Text style={{ color: selectedPlan === p.key ? "#FFF" : (isDark ? "#F0F8FF" : "#1a1a2e"), fontFamily: "Inter_700Bold", fontSize: 32 }}>
                            ₹{Math.round(p.yearlyPrice / 12)}
                          </Text>
                          <Text style={{ color: selectedPlan === p.key ? "rgba(255,255,255,0.7)" : (isDark ? "rgba(255,255,255,0.45)" : "rgba(10,22,40,0.5)"), fontFamily: "Inter_400Regular", fontSize: 13, paddingBottom: 4 }}>/mo</Text>
        ...
        <LinearGradient colors={isDark ? ["rgba(255,255,255,0.06)","rgba(255,255,255,0.02)"] : ["rgba(255,255,255,0.8)","rgba(240,249,255,0.6)"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={{ borderRadius: 18, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: isDark ? "rgba(255,255,255,0.08)" : "rgba(0,119,182,0.12)" }}>
          <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 8 }}>
            <Text style={{ color: isDark ? "rgba(255,255,255,0.6)" : "rgba(10,22,40,0.6)", fontFamily: "Inter_400Regular", fontSize: 14 }}>
              {plan.label} Plan ({billingCycle === "yearly" ? "1 year" : "1 month"})
            </Text>
            <Text style={{ color: isDark ? "#F0F8FF" : "#1a1a2e", fontFamily: "Inter_600SemiBold", fontSize: 14 }}>
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
            ...
            <View style={{ alignItems: "flex-end" }}>
              {discount > 0 && (
                <Text style={{ color: isDark ? "rgba(255,255,255,0.35)" : "rgba(10,22,40,0.35)", fontFamily: "Inter_400Regular", fontSize: 12, textDecorationLine: "line-through" }}>
                  ₹{basePrice}
                </Text>
              )}
              {billingCycle === "yearly" ? (
                <>
                  ...
                  <Text style={{ color: isDark ? "rgba(255,255,255,0.5)" : "rgba(10,22,40,0.5)", fontFamily: "Inter_400Regular", fontSize: 12 }}>≈ ₹{monthlyEquivalent}/mo</Text>
                </>
              ) : (
