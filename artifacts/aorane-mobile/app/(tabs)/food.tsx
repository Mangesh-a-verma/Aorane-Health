...
export default function FoodScreen() {
  ...
  return (
    <View style={s.root}>
      ...
      <Modal visible={showNutriReport} animationType="slide" presentationStyle="pageSheet" onRequestClose={() => setShowNutriReport(false)}>
      ...
      {/* ── QUANTITY MODAL ── */}
      <Modal visible={!!pendingFoodItem} animationType="fade" transparent presentationStyle="overFullScreen" onRequestClose={() => setPendingFoodItem(null)}>
