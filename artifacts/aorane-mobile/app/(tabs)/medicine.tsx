...
export default function MedicineScreen() {
        ...
        { text: "Cancel", style: "cancel" },
        {
          ...
          onPress: async () => {
            try {
              ...
              if (Platform.OS !== "web") {
                // ✅ FIX: Cancel only THIS medicine's notifications.
                // Old code: cancelMedicineReminders() — cancelled ALL medicines.
                await cancelMedicineById(`medicine_${med.id}`);
              }
              Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
            } catch {
  ...
  return (
    <View style={s.root}>
      ...
      {/* Add Medicine Modal                              */}
      {/* ════════════════════════════════════════════════ */}
      <Modal visible={showModal} animationType="slide" presentationStyle="pageSheet" onRequestClose={() => { setShowModal(false); setMedicineName(""); setDosage(""); }}>
        <View style={s.modalRoot}>
          <View style={s.modalHeader}>
