...
const styles = StyleSheet.create({
  ...
  logoHero: { alignItems: "center", marginBottom: 26, paddingTop: 8 },
  glowBehind: { position: "absolute", top: -30, alignSelf: "center" },
  glowCircle: { width: W * 0.9, height: 240, borderRadius: 120 },
  logo: { width: W - 40, height: 140, marginBottom: 16 },
