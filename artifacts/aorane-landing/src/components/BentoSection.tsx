...
export default function BentoSection() {
  return (
    <section id="dashboard" className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#F5F8F6] overflow-hidden">
      <div className="mesh-blob mesh-drift-1 w-[500px] h-[500px] -top-40 left-1/4" style={{ background: "radial-gradient(circle at 40% 40%, rgba(0,199,154,0.18), transparent 65%)" }} />
      <div className="relative max-w-7xl mx-auto z-[1]">
        ...
        >
          <span className="inline-flex items-center gap-2 text-xs font-bold text-[#05473C] glass-panel-soft px-3 py-1.5 rounded-full uppercase tracking-widest">
            <span className="w-1.5 h-1.5 rounded-full bg-[#00C79A]" />Live health dashboard
          </span>
          <h2 className="font-display mt-4 text-3xl sm:text-4xl font-medium text-gray-900">
            Everything in one <span className="gradient-text-teal italic">intelligent view</span>
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 auto-rows-[160px] gap-4">
          <motion.div
            ...
            className="col-span-2 row-span-1 glass-panel-soft rounded-3xl p-5 card-hover"
          >
          ...
          <motion.div
            ...
            className="col-span-1 row-span-1 bg-gradient-to-br from-[#05473C] to-[#00C79A] rounded-3xl p-5 card-hover text-white"
          >
          ...
          <motion.div
            ...
            className="col-span-1 row-span-1 glass-panel-soft rounded-3xl p-5 card-hover"
          >
          ...
          <motion.div
            ...
            className="col-span-1 row-span-1 bg-gradient-to-br from-[#00C79A] to-[#05473C] rounded-3xl p-5 card-hover text-white"
          >
            <div className="w-8 h-8 bg-white/20 rounded-xl flex items-center justify-center mb-3">
          ...
          <motion.div
            ...
            className="col-span-2 row-span-1 bg-gradient-to-r from-[#05473C] to-[#7C3AED] rounded-3xl p-5 card-hover text-white"
          >
            <div className="flex items-center gap-2 mb-1">
              <Brain className="w-5 h-5 opacity-80" />
              <p className="text-sm font-semibold opacity-80">AI-powered Health Intelligence</p>
            </div>
            <p className="text-xs opacity-60 mb-3">Powered by Aorane AI — Real-time analysis</p>
