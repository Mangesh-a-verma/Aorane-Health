...
const individualPlans: IndividualPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Wearable Sync (Health Connect)" },
    ],
  },
  {
    planKey: "max",
...
function InstallModal({ onClose }: { onClose: () => void }) {
  return (
    ...
    >
      ...
      >
        <div className="w-16 h-16 bg-[#00C79A]/12 rounded-3xl flex items-center justify-center mx-auto mb-5">
          <span className="text-3xl">📲</span>
        </div>
        <h3 className="font-display text-xl font-medium text-gray-900 mb-2">Download AORANE</h3>
        <p className="text-sm text-gray-500 mb-6">
          Launching soon on the Google Play Store. iOS to follow.
        </p>
        <div
          className="w-full py-3 rounded-2xl text-sm font-bold text-gray-500 bg-gray-100 flex items-center justify-center gap-2 cursor-default"
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <span className="inline-flex items-center gap-2 text-xs font-bold text-[#05473C] glass-panel-soft px-3 py-1.5 rounded-full uppercase tracking-widest">
            <span className="w-1.5 h-1.5 rounded-full bg-[#00C79A]" />Pricing
          </span>
          <h2 className="font-display mt-4 text-3xl sm:text-4xl font-medium text-gray-900">
            Simple, transparent <span className="gradient-text-teal italic">pricing</span>
          </h2>
