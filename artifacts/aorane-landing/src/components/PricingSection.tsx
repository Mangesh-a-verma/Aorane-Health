          ...
          >
            <div className="flex items-center justify-between gap-4 bg-gradient-to-r from-[#0747A6]/8 to-[#10B981]/8 border border-[#0747A6]/20 rounded-2xl px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900">Organization Plans — Business Portal</p>
                  <p className="text-xs text-gray-500 mt-0.5">Full features, seat management & team analytics available on business.aorane.com</p>
                </div>
              </div>
              <a
