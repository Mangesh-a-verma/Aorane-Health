...
function TestimonialCard({ t }: { t: typeof testimonials[0] }) {
  return (
    <div className="flex-shrink-0 w-80 bg-white rounded-3xl p-6 border border-gray-100 shadow-sm mx-3 flex flex-col gap-4">
...
export default function TestimonialsSlider() {
  ...
  return (
    <section className="py-20 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10 flex flex-wrap justify-center gap-3">
        {[
          { val: "4.8★", label: "Play Store Rating" },
          { val: "2L+", label: "Active Users" },
          { val: "98%", label: "Satisfaction Rate" },
          { val: "500+", label: "Companies" },
        ].map((s) => (
          <div key={s.label} className="flex items-center gap-2 bg-[#F8FAFC] rounded-2xl px-4 py-2 border border-gray-100">
            <span className="font-extrabold text-[#0747A6] text-sm">{s.val}</span>
