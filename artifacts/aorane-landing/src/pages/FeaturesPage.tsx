...
const features = [
  ...
  },
  {
    ...
    color: "#7C3AED",
    bg: "#F5F3FF",
    badge: "AI-powered · Aorane AI",
    title: "Health Intelligence",
    subtitle: "Predictive health AI that gets smarter every day.",
    desc: "Aorane AI analyses your 30+ health data points — sleep, food, exercise, vitals, stress — and delivers daily personalized insights, weekly health score trends, and early risk detection alerts tailored to your lifestyle.",
