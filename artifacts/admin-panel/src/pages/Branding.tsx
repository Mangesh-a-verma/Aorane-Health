        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">
              Company name, logo aur report templates configure karein — sab users ke scorecards aur reports pe reflect hoga.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-card border border-border rounded-2xl p-6">
            <SectionHeader icon={Building2} title="Company Identity"
              desc="Naam, logo aur basic info — scorecard footer aur reports pe dikhega" />
            <div className="space-y-4">
              ...
              <Field label="Company Logo URL">
                ...
                <p className="text-xs text-muted-foreground mt-1.5 flex items-center gap-1">
                  <Link2 size={10} />
                  Koi bhi publicly accessible image URL (PNG/SVG recommended)
                </p>
              </Field>
              <Field label="Website">
          ...
          <div className="bg-card border border-border rounded-2xl p-6 lg:col-span-2">
            <SectionHeader icon={BarChart3} title="Health Report Templates"
              desc="Weekly aur monthly reports ka header, footer aur branding configure karein. Reports medical report style mein generate hongi." />
              ...
              <div className="space-y-4">
                <Field label="Report Header Text">
                  <textarea value={settings.reportHeaderText || ""}
                    ...
                    rows={4}
                    className="w-full bg-background border border-border rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 resize-none" />
                  <p className="text-xs text-muted-foreground mt-1">Report ke upar dikhega. Blank = auto-generated.</p>
                </Field>
              </div>
              <div className="space-y-4">
                <Field label="Report Footer Text">
                  <textarea value={settings.reportFooterText || ""}
                    ...
                    rows={4}
                    className="w-full bg-background border border-border rounded-lg px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50 resize-none" />
                  <p className="text-xs text-muted-foreground mt-1">Report ke neeche dikhega. Blank = auto-generated.</p>
                </Field>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-amber-600/80 dark:text-amber-500/80 text-xs mt-0.5">
                        Aap apna khud ka PDF/image template upload kar sakenge. Abhi ke liye auto-generated medical report format use hoga jo company branding ke saath generate hogi.
                      </p>
                    </div>
                  </div>
                </div>
