...
export const api = {
  ...
  updatePlanFeature: (featureName: string, data: { freeValue?: string; maxValue?: string; proValue?: string; familyValue?: string; description?: string; period?: "daily" | "weekly" | "monthly" }) =>
